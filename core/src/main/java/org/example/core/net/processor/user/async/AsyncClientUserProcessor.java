 ...
 * @version 1.0 : ClientUserProcessor v0.1 2020/6/16 17:36 haifeng.pang Exp $
 **/
public class AsyncClientUserProcessor extends AsyncUserProcessor<RequestBody> {

    private static Logger logger = LoggerFactory.getLogger(AsyncClientUserProcessor.class);
    ...
    class InnerTask implements Runnable {
        ...
        @Override
        public void run() {
            System.out.println("Request client received:" + request.toString());
